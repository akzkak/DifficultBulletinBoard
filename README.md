...
1. Download the addon by clicking the link below:
   - [Download Difficult Bulletin Board](https://github.com/akzkak/DifficultBulletinBoard/archive/refs/heads/master.zip)
...
4. Move the `DifficultBulletinBoard` folder to your World of Warcraft AddOns directory:
   - Example path: `C:\World of Warcraft 3.3.5\Interface\AddOns`
...
Have feature suggestions or need further assistance? Feel free to [create an issue](https://github.com/akzkak/DifficultBulletinBoard/issues) on this repository and I will help you as soon as possible.
